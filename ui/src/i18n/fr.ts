...
export const fr: Record<MessageKey, string> = {
  ...
  'calib.ventBandHint':
    'C’est aussi là que s’arrête la commande Aération. Laissée à zéro, la commande n’est pas proposée. Pour obtenir une valeur : fermez complètement le volet, puis ouvrez-le et chronométrez le temps que mettent les lames à s’écarter avant que le tablier ne commence à monter — cela dure quelques secondes et se voit à l’œil nu.',
  'calib.startLagHint':
    'Le délai entre l’envoi de la commande et le moment où le moteur tourne réellement. Court — une fraction de seconde — et la mesure guidée ci-dessous n’essaie pas de l’obtenir : sur un instant aussi bref, un appui unique ne mesure guère que votre propre temps de réaction. Zéro est une valeur de départ raisonnable.',

  'calib.autoTitle': 'Mesurer avec l’appareil comme chronomètre',
  'calib.autoHint':
    'Appuyez pour lancer, regardez le volet, puis appuyez de nouveau quand il s’arrête. L’appareil ne voit pas le volet — les télécommandes Somfy ne font qu’émettre et aucun moteur ne répond — donc votre second appui est la mesure. Mais la première extrémité de celle-ci est l’horloge de l’appareil, et c’est ce qui rend cette mesure plus juste qu’un chronomètre : un chronomètre porte votre temps de réaction aux deux bouts, celle-ci ne le porte qu’à un seul. Rien n’est enregistré avant que vous appuyiez sur « Il s’est arrêté », et annuler n’enregistre rien.',
  'calib.autoCost':
  ...
  'calib.autoUpPrep':
    'Fermez complètement le volet et attendez son arrêt. Lancez ensuite : le volet s’ouvrira, et vous appuierez une fois quand il s’arrêtera. Ceci remplace Ouverture ci-dessus.',
  'calib.autoDownPrep':
    'Ouvrez complètement le volet et attendez son arrêt. Lancez ensuite : le volet se fermera, et vous appuierez une fois quand il s’arrêtera. Ceci remplace Fermeture ci-dessus.',
  'calib.autoRunning': 'En cours — {elapsed} s',
  'calib.autoWatch':
    'Regardez le volet, pas cet écran. Appuyez dès qu’il atteint la butée et que le moteur se tait.',
  ...
  'calib.autoDoNotTouch':
    'Pendant la mesure, ne commandez pas ce volet depuis ailleurs — les boutons ci-dessus, Home Assistant, ou une télécommande murale dans la maison. Chacun de ces gestes met fin à la mesure, et vous ne l’apprendrez qu’au moment où vous appuierez.',
  'calib.autoDoneUp':
    'L’ouverture a pris {seconds} s. Ouverture ci-dessus a été mis à jour, et le volet est à une butée : sa position est de nouveau exacte.',
  'calib.autoDoneDown':
    'La fermeture a pris {seconds} s. Fermeture ci-dessus a été mis à jour, et le volet est à une butée : sa position est de nouveau exacte.',
  'calib.autoCheck':
    'Vérifiez cette durée au chronomètre. Si les deux diffèrent de plus d’une seconde ou deux, c’est que vous avez appuyé trop tôt ou que quelque chose a interrompu la mesure — refaites-la, cela ne coûte rien de ce qui est déjà enregistré. Rien dans l’appareil ne peut détecter une valeur fausse mais plausible : cette comparaison est la seule chose qui le puisse.',
  'calib.autoNextDown':
  ...
  'calib.autoImplausible':
    'L’appareil refuse d’enregistrer cela : la course a duré moins d’une seconde, ou plus de trois minutes, ou moins que le délai de démarrage et l’écartement des lames saisis ci-dessus — les deux ne peuvent pas être vrais à la fois, et ce sont les valeurs enregistrées qui l’emportent. Rien n’a été modifié et la mesure est toujours ouverte : appuyez de nouveau sur « Il s’est arrêté » quand le volet s’arrête vraiment, ou annulez et recommencez.',
